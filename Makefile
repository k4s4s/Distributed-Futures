CC=mpic++
CCFLAGS=-g -DSTATS -DDEBUG -std=c++0x
LDFLAGS=-lboost_mpi -lboost_serialization -L./lib/ -lfuture -lmutex -L/home/kasas/libs/armci_mpi/lib/
...
FUTURES_SOURCES += $(wildcard futures/mem/*.cpp)
...
FUTURES_HEADERS += $(wildcard futures/mem/*.hpp)
