...
%\subsection{Alternative Implementations/Design Versatility}
%\label{sect:impl_alt_impl}
...
%multiple \emph{jobs}, without breaking the asynchronous model.  Moreover, \emph{communication} should only
