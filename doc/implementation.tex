...
Figure~\ref{fig:hello_flow} shows a control flow graph for the master and worker processes.  
...
There are knows solutions as to how to implement such systems in the literature.  The two most commonly used methods
are polling for work requests ~\cite{Beckman96tulip:a, Saunders:2003:AAP:966049.781534} and hardware interrupts .  Polling requires the 
